...
export declare namespace androiddeviceprovisioning_v1 {
    ...
    export class Resource$Partners$Devices {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getSimLockState(params: Params$Resource$Partners$Devices$Getsimlockstate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getSimLockState(params?: Params$Resource$Partners$Devices$Getsimlockstate, options?: MethodOptions): GaxiosPromise<Schema$GetDeviceSimLockStateResponse>;
