...
export declare namespace cloudsupport_v2beta {
    ...
    export class Resource$Cases {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        showFeed(params: Params$Resource$Cases$Showfeed, options: StreamMethodOptions): GaxiosPromise<Readable>;
        showFeed(params?: Params$Resource$Cases$Showfeed, options?: MethodOptions): GaxiosPromise<Schema$ShowFeedResponse>;
