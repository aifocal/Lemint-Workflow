...
export declare namespace cloudsearch_v1 {
    ...
    export class Resource$Query {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        debugSearch(params: Params$Resource$Query$Debugsearch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        debugSearch(params?: Params$Resource$Query$Debugsearch, options?: MethodOptions): GaxiosPromise<Schema$DebugResponse>;
